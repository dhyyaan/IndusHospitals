...
/**
 * Created by think360 on 11/04/17.
 */
...
public class MaterialSpinner extends AppCompatSpinner implements ValueAnimator.AnimatorUpdateListener {
    ...
    */
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        int defaultErrorColor = context.getResources().getColor(R.color.ecinnabar_red);
        ...
        disabledColor = context.getResources().getColor(R.color.dark_grey);
    ...
    private void initPaintObjects() {
        ...
        int labelTextSize = getResources().getDimensionPixelSize(R.dimen.twelve_sp);
    ...
    private void initDimensions() {
        underlineTopSpacing = getResources().getDimensionPixelSize(R.dimen.eight_dp);
        underlineBottomSpacing = getResources().getDimensionPixelSize(R.dimen.four_dp);
        floatingLabelTopSpacing = getResources().getDimensionPixelSize(R.dimen.four_dp);
        floatingLabelBottomSpacing = getResources().getDimensionPixelSize(R.dimen.eight_dp);
        rightLeftSpinnerPadding = alignLabels ? getResources().getDimensionPixelSize(R.dimen.eight_dp) : 0;
        floatingLabelInsideSpacing = getResources().getDimensionPixelSize(R.dimen.twelve_dp);
        errorLabelSpacing = (int) getResources().getDimension(R.dimen.twelve_dp);
        minContentHeight = (int) getResources().getDimension(R.dimen.twenty_dp);
    }
