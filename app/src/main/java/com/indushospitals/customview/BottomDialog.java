...
import com.indushospitals.model.Item;
import com.indushospitals.utils.UtilsColor;

import java.util.ArrayList;
import java.util.List;
//https://github.com/rebus007/BottomDialog/tree/master/library/src/main/res/values
...
public class BottomDialog {
    ...
    private class CustomDialog extends Dialog implements View.OnClickListener {
        ...
        public void addItem(Item item) {
            ...
            row.setTextColor(UtilsColor.colorStateListText(getContext()));
        ...
        private Drawable icon(Drawable drawable) {
            if (drawable != null) {
                ...
                DrawableCompat.setTintList(resizeIcon, UtilsColor.colorStateListIcon(getContext()));
                return resizeIcon;
            }
            return null;
        }
